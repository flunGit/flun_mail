import SERVICES from './services.json' with { type: 'json' }; // 导入服务配置
import { regexs, resetRegex } from '../regexs.js';            // 导入正则表达式及其重置函数

const normalized = {}, // 储存规范的服务对象
