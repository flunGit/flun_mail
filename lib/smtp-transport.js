...
import {
    initSmtpConstructor, getSocket, createSmtpConnection, setupConnectionHandlers, createAuthConfig,
    prepareMessageForSending, handleSendResult, performSmtpAuthentication, verifySmtp
} from './shared.js';

/**
 * 为flun-mail创建SMTP传输对象./fetch
 *
 * @constructor
