'use strict';
// 引入必要的Node.js内置模块
const http = require('http'), https = require('https'), NET = require('net'), zlib = require('zlib'), // 压缩解压模块
    { PassThrough } = require('stream'), // 流处理模块
    PK = require('../../package.json'), Cookies = require('flun-mail/lib/fetch/cookies'), MAX_REDIRECTS = 5;               // 最大重定向次数常量
