...
import { PK, getLogger, prepareMessageForSending, cleanup } from './shared.js';
...
class SendmailTransport {
    ...
    send(mail, done) {
        let sendmail;
        const { args, envelope, messageId, readStream } // 邮件预处理
            = prepareMessageForSending(mail, this.logger, '', { sArgs: this.args, transportType: 'sendmail' }),
