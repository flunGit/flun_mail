'use strict';
const path = require('path'), { MIME_TYPES, EXTENSIONS } = require('./mime-types'), { regexs, resetRegex } = require('../regexs'),
    { base64Encode } = require('../base64'), { qpEncode } = require('../qp'),

    defaultMimeType = 'application/octet-stream', // 默认的MIME类型(通用的二进制数据流)
    defaultExtension = 'bin';                     // 默认的文件扩展名
