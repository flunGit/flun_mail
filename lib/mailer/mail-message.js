'use strict';
// 引入所需模块
const MimeNode = require('../mime-node'), { regexs, resetRegex, resolveContent } = require('../shared'),
    { detectExtension, detectMimeType, isPlainText, encodeWord } = require('../mime-funcs');
