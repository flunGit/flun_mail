...
// 导入所需模块
const EventEmitter = require('events'), LeWindows = require('./mime-node/le-windows'),
    { PK, getLogger, callbackPromise, prepareMessageForSending, resolveStream } = require('./shared');
