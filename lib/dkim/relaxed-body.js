...
class RelaxedBody extends Transform {
    ...
    updateHash(chunk) {
        ...
        const fullStr = this.remainder + chunk.toString('latin1');
        ...
        const processedChunk = Buffer.from(processedStr, 'latin1');      // 将处理后的字符串转换回Buffer
        ...
        try {
            ...
            if (this.remainder) {
                ...
                const rMW = resetRegex(regexs.MULTIPLE_WSP),
                    ...
                    remainderChunk = Buffer.from(pRemainder, 'latin1');
