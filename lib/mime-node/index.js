...
// 引入自定义模块
import { QpEncoder } from '../qp.js';
import { Base64Encoder } from '../base64.js';
import { toASCII } from '../punycode.js';
import { addressparser } from '../addressparser.js';
import { fsReadStream, nmfetch, regexs, resetRegex, callbackPromise, cleanup, resolveStream } from '../shared.js';
import {
    detectMimeType, isPlainText, hasLongerLines, foldLines, parseHeaderValue, buildHeaderValue, encodeWord, encodeWords
} from '../mime-funcs/index.js';
...
class MimeNode {
    ...
    #getStream(content = {}) {
        ...
        // 如果是文件路径：根据访问权限返回文件流或错误流
            ...
            return this.disableFileAccess ? createErrorStream(`文件访问被拒绝:${path}`) : fsReadStream(path);
